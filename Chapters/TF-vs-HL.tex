...
\section{Comparaison globale des programmes transcriptionnels régulés par les hormones thyroïdiennes et les glucocorticoïdes}
	...
	\input{Figures/comparison-tfc-hlc-de-genes/comparison-tfc-hlc-de-genes}
...
\section{Vieillissement}
	...
	\input{Figures/comparison-tfc-hlc-aging/comparison-tfc-hlc-aging}
...
\section{Les modificateurs post-traductionnels des histones}\label{sec:res-histones}
	...
	\input{Figures/comparison-tfc-hlc-histones/comparison-tfc-hlc-histones}
...
\section{La méthylation de l'ADN}
	...
	\input{Figures/comparison-tfc-hlc-medna/comparison-tfc-hlc-medna}
...
\section{Métabolisme et signalisation des hormones thyroïdiennes}
	...
	\input{Figures/comparison-tfc-hlc-htsig/comparison-tfc-hlc-htsig}
