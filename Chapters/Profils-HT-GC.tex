...
\end{itemize}
Enfin, il intéressant de noter que d'autres facteurs de transcription tels que les \glspl{stat} (notamment \gls{stat5} et gls{stat}6) et \gls{nfkb} sont régulée par les les \glspl{ht} et les \glspl{gc}.
