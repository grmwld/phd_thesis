...
Chez les amphibiens, la \gls{cort} est le \gls{gc} naturellement produit lors d'un stress \insertref{GC cort amphib}.
...
Cette fenêtre de temps est classiquement utilisée dans la littérature, facilitant la comparaison des résultats obtenus, et permet d'observer les premières réponses moléculaires aux traitements hormonaux \insertref{24h treatment}.
