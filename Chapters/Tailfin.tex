...
\section{Caractéristiques générales}
	...
	\input{Figures/tfc-maplot/tfc-maplot}
	...
	\input{Figures/tfc-heatmap-de-genes/tfc-heatmap-de-genes}
...
\section{Annotation fonctionnelle automatisée}
	...
	\input{Figures/tfc-go-all-graph/tfc-go-all-graph}
	...
	\input{Figures/tfc-go-all-treemap/tfc-go-all-treemap}
	...
	\input{Figures/tfc-clusters-pot/tfc-clusters-pot}

	\input{Figures/tfc-clusters-antago/tfc-clusters-antago}
	...
	\input{Figures/tfc-go-pot-down/tfc-go-pot-down}
	...
	\input{Figures/tfc-go-pot-up/tfc-go-pot-up}
	...
	\input{Figures/tfc-go-antago-cort/tfc-go-antago-cort}

	\input{Figures/tfc-go-antago-t3/tfc-go-antago-t3}
...
\section{Annotation fonctionnelle manuelle: complément à la caractérisation automatisée de termes enrichis}
	...
	\subsection{Annotation manuelle des gènes régulés de façon croisée par les hormones thyroïdiennes et les glucocorticoïdes}
		...
		\input{Figures/tfc-manualannot-pot-vs-antago/tfc-manualannot-pot-vs-antago}
	...
	\subsection{Annotation manuelle des gènes constituant les profils ``d'antagonisme''}
		...
		\input{Figures/tfc-manualannot-antago/tfc-manualannot-antago}
	...
	\subsection{Annotation manuelle des gènes constituant les profils ``potentiés''}
		...
		\input{Figures/tfc-manualannot-pot/tfc-manualannot-pot}
