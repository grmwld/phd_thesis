...
\par
\comment{à discuter de vive voix}
...
Cependant, l'expression de \gls{dnmt}3A est induite par les \gls{ht}, suggérant une méthylation \textit{de novo} au niveau de certains sites. \explainindetail{Bien que \gls{dnmt}3A soit aussi impliquée dans la déméthylation \citep{Wu2010} ... Pourquoi dis-tu qu'on ne se trouve pas dans les conditions ? il me semble que c'est quand les niveaux de SAM sont bas, mais on n'a pas moyen de le mesurer, ni même de l'inférer p/r à nos données ?}.
\par
...
Malgré un "lissage"\comment{Le fait que les réponses - variables - de chaque cellule sont nivellées à l'échelle du tissu => moyenne. Je ne sais pas trop comment le dire de façon claire et succinte} de la réponse lié à l'intégration au niveaux des tissus de la variabilité de la réponse par chaque cellule, cette stochasticité moléculaire à des conséquences profondes au niveau des tissus et de l'organisme dans son ensemble.
On observe en effet chez des grenouilles juvéniles issues de têtards traités aux \glspl{gc} une grande variabilité dans l'amplitude du phénotype squelettique.\comment{à discuter de vive voix}
\par
On sait qu'une partie de la diversité phénotypique au sein d'une population repose sur un variabilité génétique \insertref{phenotype génotype}.
