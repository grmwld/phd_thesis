...
Alors qu'il est bien décrit dans la littérature que les \glspl{ht} et les \glspl{gc} sont cruciaux lors du développement squelettique \insertref{ref, williams etc}, ces données apportent les premiers éléments de réponse moléculaires vers une élucidation du rôle et des conséquences développementales de l'interaction croisée entre deux voies de signalisation.
...
%\end{abstract}
%
%\explainindetail{Inserer article hindlimb}
...
\input{Figures/hlc-heatmap-de-genes/hlc-heatmap-de-genes}
...
\input{Figures/hlc-go-all-graph/hlc-go-all-graph}
...
\input{Figures/hlc-go-all-treemap/hlc-go-all-treemap}
...
\input{Figures/hlc-go-antago-down/hlc-go-antago-down}
...
\input{Figures/hlc-go-antago-up/hlc-go-antago-up}
...
\input{Figures/hlc-go-pot-up/hlc-go-pot-up}
...
\input{Figures/hlc-go-pot-down/hlc-go-pot-down}
...
\end{itemize}
\input{Figures/hlc-manualannot-pot-vs-antago/hlc-manualannot-pot-vs-antago}
...
\input{Figures/hlc-manualannot-antago/hlc-manualannot-antago}
...
\input{Figures/hlc-manualannot-pot/hlc-manualannot-pot}
